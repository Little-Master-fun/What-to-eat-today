    ...
    <el-row>
      ...
      <el-col :span="15" justify="space-between">
        <el-row justify="space-between">
          <el-col :span="9"><el-text style="font-size: 16px; color: black">{{ props.dish.name }}</el-text></el-col>
          <el-col :span="10">
            <el-text style="font-size: 15px; margin-right: 25px; color: black">{{ props.dish.price }}元</el-text>
          </el-col>
        </el-row>
        <el-row style="margin-top: 3vh" justify="space-between">
          <el-col :span="9"><el-text style="font-size: 16px">{{ dishlocation }}</el-text></el-col>
          <el-col :span="11">
            <el-button class="detailButton" round @click="router.push('/detail/' + props.dish.id)"><el-text
